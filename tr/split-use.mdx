---
title: 'Bir Split Grubuna Ödeme Ekleme'
description: "Bir Split Grubuna Ödeme Ekleme Kılavuzu."
---

Arkadaşlarınızla paylaşılan masrafları yönetmek hiç bu kadar kolay olmamıştı. Clave uygulamasını kullanarak split grubunuza nasıl ödeme ekleyebileceğinizi öğrenmek için aşağıdaki adımları izleyin:

1. **Clave Uygulamasını Açın**:
   Cihazınızdaki Clave uygulamasını açın ve split grubunuza gidin.

2. **Grubu Seçin**:
   Ödeme eklemek istediğiniz split grubunu seçin.
...
Tebrikler! Split grubunuza başarıyla bir ödeme eklediniz. Bu, paylaşılan tüm masrafların organize olmasını sağlar ve herkesin kendi payından haberdar olmasını garanti eder.
